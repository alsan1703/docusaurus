...
Konten web app Phibase.IO terdiri dari 10 domain, antara lain **Main**, **Commerce**, **Manufacture**, **Distribution**, **Maintenance**, **Quality Control**, **Finance**, **Report**, **Schedule**, dan **Analytics**. Pada **Gambar 10** menunjukan flow antar domain.
